...
/**
 * A class to represent a Recipe that is a Seafood Recipe.
 * 
...
/**
 * Constructor to construct an instance of a seafood recipe
 * 
 * @param title the title of the recipe
 * @param ingredients the ingredients of the recipe
 * @param directions the directions of the recipe
 */
    public SeafoodRecipe(String title, String ingredients, String directions)
    {
